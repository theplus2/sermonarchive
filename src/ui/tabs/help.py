...
def render_help():
    ...
    st.caption("설교자의 서재 v5.3.4 사용 가이드")
    ...
    with tab4:
        ...
        **🔧 개선 사항**
        ...
        #### 🆕 v5.3.3 (2026-01-25) - macOS 사용자 가이드 개선
        
        **🔧 개선 사항**
        - 🍎 **macOS 실행 안내**: Ad-hoc 서명 적용에 맞춰 설치 가이드를 더욱 직관적으로 수정했습니다. (복잡한 터미널 명령어 없이 "우클릭 > 열기"로 실행 가능)
        ...
        **💡 macOS 실행 팁**
        - 다운로드 받은 파일을 더블클릭하지 말고, **[우클릭] > [열기]**를 누르면 보안 경고 없이 실행할 수 있습니다.
